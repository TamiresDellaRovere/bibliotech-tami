...
export function EditarLivro() {
    ...
    function onSubmit(data) {
        updateLivro(id, data).then(() =>{
            ...
            navigate ("/livros");
        }) //função que edita e atualiza os dados do livro 
    }

    useEffect(() => {
        getLivro(id).then( livro => {
            reset(livro) //reset recebe o livro e preenche os campos titulo, categoria.....
        })
    }, [id, reset]); //função que traz o livro do Firebase
